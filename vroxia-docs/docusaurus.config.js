      ...
      navbar: {
        ...
        items: [
          ...
          },
          {
            type: 'html',
            position: 'right',
            value: `<a href="https://instagram.com/vroxiaprotocol" target="_blank" rel="noopener noreferrer" class="navbar__social-link navbar__social-link--ig" aria-label="Instagram">
          ...
          },
          {
            type: 'html',
            position: 'right',
            value: `<a href="https://facebook.com/vroxiaprotocol" target="_blank" rel="noopener noreferrer" class="navbar__social-link navbar__social-link--fb" aria-label="Facebook">
          ...
          },
          {
            ...
            items: [
              ...
              },
              {
                ...
                label: '📸  Instagram',
                href: 'https://instagram.com/vroxiaprotocol',
              },
              {
                // TODO: Replace with official Facebook URL
                label: '📘  Facebook',
                href: 'https://facebook.com/vroxiaprotocol',
              },
            ],
          },
          {
            ...
            items: [
              {
                // TODO: Replace with official organization email
                label: '✉  contact@vroxiaprotocol.com',
                href: 'mailto:contact@vroxiaprotocol.com',
              },
            ],
          },
        ],
        copyright: `Copyright © ${new Date().getFullYear()} Vroxia Protocol. All rights reserved. · contact@vroxiaprotocol.com`,
      },
      prism: {
